...
function sendSingleFetchResponse({ res, data, entity, is_singular = false }) {
  let status_code = data ? response_map.fetch.code : response_map.notFound.code;
...
function sendFetchResponse({ res, data, entity }) {
  let status_code = response_map.fetch.code;
  res.status(status_code).json({
    status_code,
    success: true,
...
function sendCreateResponse({ res, data, entity }) {
  let status_code = response_map.create.code;
  res.status(status_code).json({
    success: true,
